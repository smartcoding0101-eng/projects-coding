export default function FloatingWhatsApp() {
    return (
        <a 
            ...
            className="fixed bottom-8 right-8 z-[100] bg-[#25D366] text-white p-4 rounded-full shadow-[0_15px_40px_rgba(37,211,102,0.4)] hover:scale-110 hover:-translate-y-2 transition-all duration-300 group flex items-center justify-center cursor-pointer border-4 border-white"
