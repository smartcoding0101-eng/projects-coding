                    ...
                    <div className={`flex justify-between items-center transition-all duration-500 border origin-top ${scrolled ? 'bg-white/95 backdrop-blur-2xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] rounded-full border-white/50 px-6 h-16' : 'bg-transparent border-transparent px-2 h-20'}`}>
                        ...
                        <div className="flex items-center gap-3 lg:gap-5 shrink-0">
                            <Link href="/login" className="hidden lg:flex font-semibold text-gray-600 hover:text-primary transition-colors items-center gap-1.5 text-[13px] tracking-wide">
                                <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1" /></svg>
                                Portal Socio
                            </Link>
                            <Link href="/register" className="bg-primary text-white font-semibold px-5 py-2 rounded-full hover:bg-primary-dark hover:shadow-lg transition-all transform hover:-translate-y-0.5 shadow-md shadow-primary/20 hidden sm:block text-[13px] tracking-wide">
                                Únete Ahora
                            </Link>
                        </div>
                    </div>
