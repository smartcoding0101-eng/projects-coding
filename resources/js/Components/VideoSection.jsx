...
export default function VideoSection() {
    ...
    const playVideo = (video) => {
        ...
        // Pequeño timeout para asegurar que el elemento existe antes de pedir fullscreen
        setTimeout(() => {
            if (videoRef.current) {
    ...
    const mainVideo = {
        title: "¿Qué significa ser Fapclas?",
        sub: "Spot Institucional",
        url: "https://vjs.zencdn.net/v/oceans.mp4", // Sample video
        img: "https://images.unsplash.com/photo-1551836022-d5d88e9218df?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80"
    };

    const galleryVideos = [
        { title: "Campaña de Créditos Solidarios", sub: "Beneficios 2026", url: "https://vjs.zencdn.net/v/oceans.mp4", img: "https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?auto=format&fit=crop&w=800&q=80" },
        { title: "Testimonio Socio Activo Oficial", sub: "La Paz, Bolivia", url: "https://vjs.zencdn.net/v/oceans.mp4", img: "https://images.unsplash.com/photo-1544928147-79a2dbc1f389?auto=format&fit=crop&w=800&q=80" },
        { title: "Tutorial Plataforma Digital ERP", sub: "Educación Financiera", url: "https://vjs.zencdn.net/v/oceans.mp4", img: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=800&q=80" }
    ];
        ...
        <section className="py-12 bg-surface-container overflow-hidden relative" id="videos">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                     ...
                     {galleryVideos.map((video, idx) => (
                        ...
                        >
                             ...
                             <div className="absolute inset-0 bg-black/20 group-hover:bg-black/50 transition-colors duration-500 flex items-center justify-center">
                                 ...
                                 <div className="w-12 h-12 bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center hover:bg-white/30 hover:scale-110 transition-all border border-white/50 shadow-[0_0_20px_rgba(255,255,255,0.15)] group-hover:shadow-[0_0_30px_rgba(255,255,255,0.3)]">
                 ...
                 {/* Video Player Modal/Overlay (Solo se muestra cuando hay un video activo) */}
                 {activeVideo && (
                     <div 
                    ...
                    >
                         <button 
                            onClick={closeVideo}
                            className="absolute top-6 right-6 text-white/70 hover:text-white bg-white/10 p-3 rounded-full backdrop-blur-md transition-all z-[110]"
                        >
                            <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12"/></svg>
                         </button>
                         
                         <div className="w-full max-w-6xl aspect-video rounded-3xl overflow-hidden shadow-[0_0_100px_rgba(102,153,51,0.3)] bg-black relative">
                            <video 
                                ref={videoRef}
                                src={activeVideo.url}
                                controls
