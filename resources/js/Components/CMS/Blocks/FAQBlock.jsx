            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-10">
                    ...
                    <h2 className="font-display text-4xl md:text-5xl font-bold text-on-surface mb-6 md:min-h-[60px]">
                        <TextType text={title || 'Preguntas Frecuentes'} as="span" typingSpeed={75} deletingSpeed={50} showCursor cursorCharacter="_" />
                    </h2>
                ...
                <div className="space-y-4">
                    {items.map((faq, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                className={`group rounded-3xl overflow-hidden transition-all duration-300 border ${isOpen
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className={`w-8 h-8 rounded-full border flex items-center justify-center shrink-0 transition-all ${isOpen
                                ...
                                <div className={`px-6 md:px-8 overflow-hidden transition-all duration-500 ease-in-out ${isOpen ? 'max-h-96 pb-6 lg:pb-8 opacity-100' : 'max-h-0 opacity-0'
                                    }`}>
