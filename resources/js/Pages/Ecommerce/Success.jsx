    ...
    return (
        <StoreLayout>
            ...
            <div className="max-w-3xl mx-auto py-20 px-4">
                <div className="bg-card-fap rounded-3xl shadow-xl shadow-gray-200/50 p-8 md:p-12 text-center border border-brand relative overflow-hidden">
                    ...
                    <h1 className="text-3xl md:text-4xl font-extrabold text-brand-main mb-2">¡Gracias por tu compra!</h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left mb-10">
                        <div className="bg-brand/5 border border-brand p-6 rounded-2xl">
                            <h3 className="text-sm font-bold text-brand-main mb-4 flex items-center uppercase tracking-wider"><ShoppingBag className="w-4 h-4 mr-2 text-[#618541]" /> Resumen</h3>
                            <div className="space-y-2 text-sm text-gray-600">
                                ...
                                <div className="flex justify-between"><span>Método:</span> <span className="font-medium text-brand-main">{pedido.tipo_pago === 'qr' ? 'Transferencia QR' : 'Crédito Asociado'}</span></div>
