                ...
                {relacionados && relacionados.length > 0 && (
                    <div className="mt-20">
                        <div className="flex items-center justify-between mb-8">
                            ...
                            <Link href={route('beneficios.index', { categoria: producto.categoria?.slug })} className="text-sm font-bold text-[#F7BD16] hover:text-[#28361d] transition-colors">
                                        ...
                                        <Link href={route('beneficios.show', rel.id)}>
                                            <div className="aspect-[4/3] bg-brand/5 relative overflow-hidden p-6 flex items-center justify-center">
                                                ...
                                                {isSocio && rel.precio_asociado < rel.precio_general && (
                                                    <div className="absolute top-2 right-2 bg-[#F7BD16] text-white text-[10px] font-bold px-2 py-1 rounded shadow-sm">
                                                        PRECIO SOCIO
                                                    </div>
                                                )}
                                            </div>
