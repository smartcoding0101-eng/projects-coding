                ...
                <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
                        ...
                        <motion.div 
                            ...
                            className="bg-gray-50 flex items-center justify-center p-12 relative overflow-hidden group"
                        >
                        ...
                        >
                            ...
                            <h1 className="text-3xl lg:text-4xl font-extrabold text-gray-900 mb-4">{producto.nombre}</h1>
                            ...
                            <div className="mb-8">
                                <div className="text-sm text-gray-500 mb-1">Precio Unitario</div>
                                <div className="flex items-end gap-4">
                                    <span className="text-4xl font-black text-gray-900">Bs. {precioReal}</span>
                                    {isSocio && producto.precio_asociado < producto.precio_general && (
                                        <span className="text-lg text-gray-400 line-through mb-1">Bs. {producto.precio_general}</span>
                                    )}
                                </div>
                            </div>
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex items-center border border-gray-200 rounded-lg overflow-hidden bg-white">
                                            ...
                                            >-</button>
                                            <div className="w-12 text-center font-bold text-gray-900">{cantidad}</div>
                                            <button 
                ...
                {relacionados && relacionados.length > 0 && (
                    <div className="mt-20">
                        <div className="flex items-center justify-between mb-8">
                            <h2 className="text-2xl font-black text-gray-900">Quizás también te interese</h2>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                            {relacionados.map(rel => {
                                ...
                                return (
                                    <div key={rel.id} className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
                                        ...
                                        <div className="p-4 border-t border-gray-50">
                                            <Link href={route('beneficios.show', rel.id)}>
                                                <h3 className="font-bold text-gray-900 text-sm mb-1 line-clamp-1 hover:text-[#618541] transition-colors">
                                                    {rel.nombre}
                                                </h3>
                                            </Link>
                                            <div className="text-sm font-black text-gray-900">Bs. {relPrecio}</div>
                                        </div>
                                    </div>
                                );
                            })}
