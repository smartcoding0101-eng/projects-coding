...
export default function Register() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 sm:p-8 selection:bg-primary/20">
            ...
            <div className="w-full max-w-5xl bg-white rounded-3xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.08)] overflow-hidden flex flex-col lg:flex-row border border-gray-100 min-h-[650px] transform transition-all">
                ...
                <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 py-10 lg:px-16 bg-white z-10">
                    <div className="w-full max-w-sm mx-auto">
                        ...
                        <div className="mb-8 text-center lg:text-left">
                            ...
                            <h2 className="font-display text-2xl md:text-3xl font-bold text-gray-900 mb-2 tracking-tight">Registro de Socio</h2>
                            <p className="text-gray-500 font-medium text-sm leading-relaxed">Completa los campos para procesar tu solicitud de ingreso.</p>
                        </div>
                        ...
                        <form onSubmit={submit} className="space-y-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="name"
                                    value={data.name}
                                    className={`w-full px-4 py-3 bg-gray-50 border ${errors.name ? 'border-red-300 focus:ring-red-500 focus:border-red-500 bg-red-50' : 'border-gray-200 focus:border-primary focus:ring-primary focus:bg-white'} rounded-xl text-gray-900 text-sm transition-all font-medium focus:ring-2 focus:ring-opacity-20 outline-none shadow-sm`}
                                    autoComplete="name"
                                    autoFocus={true}
