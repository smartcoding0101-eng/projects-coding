                ...
                <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 py-10 lg:px-16 bg-card-fap z-10">
                    <div className="w-full max-w-sm mx-auto">
                        ...
                        <div className="mb-8 text-center lg:text-left">
                            ...
                            <h2 className="font-display text-2xl md:text-3xl font-bold text-brand-main mb-2 tracking-tight">Portal de Acceso</h2>
                            <p className="text-brand-muted font-medium text-sm leading-relaxed">Ingresa tus credenciales para acceder a tu ecosistema financiero.</p>
                        </div>
                            ...
                            <div>
                                ...
                                <div className="relative flex items-center group/pass">
                                    ...
                                    <button
                                        ...
                                        className="absolute inset-y-0 left-0 pl-3.5 flex items-center justify-center text-brand-muted hover:text-primary transition-all duration-200 z-20 hover:scale-110 focus:outline-none"
                            ...
                            <div className="flex items-center justify-between pt-1">
                                <label className="flex items-center cursor-pointer group">
                                    <input
                                        ...
                                        className="rounded border-brand text-primary shadow-sm focus:ring-primary focus:ring-opacity-30 w-4 h-4 transition-all cursor-pointer bg-brand/5"
                                    />
                                    <span className="ms-2 text-xs font-semibold text-brand-muted group-hover:text-brand-main transition-colors">Mantener sesión</span>
                                </label>
