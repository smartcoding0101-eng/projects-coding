...
export default function LeyesNormativas({ siteSettings = {} }) {
                    ...
                    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-16">
                            <span className="bg-primary/10 text-primary uppercase font-bold text-xs tracking-widest px-4 py-1.5 rounded-full inline-block mb-4">
                                Transparencia Activa Institucional
                            </span>
                            <h1 className="font-display text-4xl md:text-5xl font-bold text-on-surface mb-4">
                                Repositorio Normativo Boliviano
                            </h1>
                            <p className="text-xl text-brand-muted max-w-2xl mx-auto">
                                Regulados y respaldados oficialmente por el Estado Plurinacional de Bolivia para brindarte total seguridad técnica y financiera.
                            </p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            ...
                            <div className="bg-card-fap rounded-[2rem] p-8 md:p-10 border border-brand shadow-[0_20px_40px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_50px_rgba(59,130,246,0.1)] transition-all duration-300 group flex flex-col">
                                ...
                                <DocumentAction
                                    filePath="pages/normativas/ley-393.pdf"
                                    label="Descargar Ley 393 PDF"
                                    btnClass="text-blue-600 bg-blue-50/50"
                                />
                            </div>
                            ...
                            <div className="bg-card-fap rounded-[2rem] p-8 md:p-10 border border-brand shadow-[0_20px_40px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_50px_rgba(16,185,129,0.1)] transition-all duration-300 group flex flex-col">
                                ...
                                <DocumentAction
                                    filePath="pages/normativas/ley-356.pdf"
                                    label="Descargar Ley 356 PDF"
                                    btnClass="text-emerald-600 bg-emerald-50/50"
                                />
                            </div>
                            ...
                            <div className="bg-card-fap rounded-[2rem] p-8 md:p-10 border border-brand shadow-[0_20px_40px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_50px_rgba(85,107,47,0.15)] transition-all duration-300 group flex flex-col">
                                ...
                                <DocumentAction
                                    filePath="pages/normativas/estatuto.pdf"
                                    label="Ver Documento en Línea"
                                    btnClass="text-primary bg-primary/10"
                                />
                            </div>

                            {/* ── PUNTO DE RECLAMO (PRF) ────────────────────────────────── */}
                            <div className="bg-card-fap rounded-[2rem] p-8 md:p-10 border border-brand shadow-[0_20px_40px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_50px_rgba(255,215,0,0.15)] transition-all duration-300 group flex flex-col">
                                ...
                                <DocumentAction
                                    filePath="pages/normativas/prf.pdf"
                                    label="Formulario Electrónico"
                                    btnClass="text-secondary-dark bg-secondary/10"
                                />
                            </div>
