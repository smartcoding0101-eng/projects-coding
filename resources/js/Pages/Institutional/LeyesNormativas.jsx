                ...
                <main className="flex-grow pt-32 pb-24">
                    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            {/* LEY 393 ASFI */}
                            <div className="bg-card-fap rounded-[2rem] p-8 md:p-10 border border-brand shadow-[0_20px_40px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_50px_rgba(59,130,246,0.1)] transition-all duration-300 group">
                                ...
                                <p className="text-brand-muted mb-8 font-sans leading-relaxed text-base min-h-[100px]">
                            ...
                            {/* LEY 356 AFCOOP */}
                            <div className="bg-card-fap rounded-[2rem] p-8 md:p-10 border border-brand shadow-[0_20px_40px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_50px_rgba(16,185,129,0.1)] transition-all duration-300 group">
                                <div className="flex items-center gap-5 mb-6">
                            ...
                            {/* ESTATUTO */}
                            <div className="bg-card-fap rounded-[2rem] p-8 md:p-10 border border-brand shadow-[0_20px_40px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_50px_rgba(85,107,47,0.15)] transition-all duration-300 group">
                                <div className="flex items-center gap-5 mb-6">
                                ...
                                <p className="text-brand-muted mb-8 font-sans leading-relaxed text-base min-h-[80px]">
                            ...
                            {/* PRF */}
                            <div className="bg-card-fap rounded-[2rem] p-8 md:p-10 border border-brand shadow-[0_20px_40px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_50px_rgba(255,215,0,0.15)] transition-all duration-300 group">
                                <div className="flex items-center gap-5 mb-6">
