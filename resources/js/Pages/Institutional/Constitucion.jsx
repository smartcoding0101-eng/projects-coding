                ...
                <main className="flex-grow pt-32 pb-24">
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-xl text-brand-muted">Construyendo el futuro de la clase policial con solidaridad financiera.</p>
                        </div>
                        <div className="bg-card-fap rounded-3xl p-10 md:p-14 border border-brand shadow-[0_20px_60px_rgba(0,0,0,0.05)]">
                            <div className="prose prose-lg md:prose-xl max-w-none text-gray-600 font-sans leading-relaxed">
                                ...
                                <div className="grid sm:grid-cols-2 gap-6 mt-6">
                                    <div className="bg-brand/5 rounded-2xl p-6 border border-brand">
                                        ...
                                        <p className="text-sm text-brand-muted">Demostramos cuentas y finanzas infaliblemente claras frente a cada uno de nuestros afiliados.</p>
                                    </div>
                                    <div className="bg-brand/5 rounded-2xl p-6 border border-brand">
                                        <h4 className="font-bold text-lg text-primary mb-2 flex items-center gap-2">
                                            <span className="w-3 h-3 bg-secondary rounded-full"></span> Solidaridad Mutual
                                        </h4>
                                        <p className="text-sm text-brand-muted">El soporte cooperativo está predispuesto para acudir en auxilio económico de los policías y la fuerza activa operativa.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
